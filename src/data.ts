...
export const RIC_STAGES = [
  {
    stage: 1,
    titleEn: 'Abstract Submission',
    titleId: 'Pengumpulan Abstrak',
    descriptionEn: 'Submit your research abstract in PDF format. Maximum 500 words, following the provided template.',
    descriptionId: 'Kumpulkan abstrak penelitian Anda dalam format PDF. Maksimal 500 kata, mengikuti template yang disediakan.',
    requirements: [
      'PDF file (.pdf)',
      'Maximum 500 words',
    ...
    submitLabelEn: 'Submit Abstract',
    submitLabelId: 'Kumpulkan Abstrak',
    icon: 'FileText'
  },
  {
    stage: 2,
    titleEn: 'Full Proposal & Video',
    titleId: 'Proposal Lengkap & Video',
    descriptionEn: 'Submit your full research proposal in PDF format along with a video prototype link (YouTube/Google Drive).',
    descriptionId: 'Kumpulkan proposal penelitian lengkap dalam format PDF beserta tautan video prototipe (YouTube/Google Drive).',
    requirements: [
      'Full proposal PDF (.pdf)',
      'Video prototype link (YouTube/Drive)',
      'Follow the official template',
      'File size max 10MB'
    ],
    submitLabelEn: 'Submit Proposal & Video',
    submitLabelId: 'Kumpulkan Proposal & Video',
    icon: 'FileText'
  },
  {
    stage: 3,
    titleEn: 'Digital Poster & PPT',
    titleId: 'Poster Digital & PPT',
    descriptionEn: 'Submit your digital poster in PDF format and presentation slides (PPT/PDF).',
    descriptionId: 'Kumpulkan poster digital dalam format PDF dan slide presentasi (PPT/PDF).',
    requirements: [
      'Digital poster PDF (.pdf)',
      'Presentation slides (.ppt/.pdf)',
      'Follow the provided format',
      'File size max 10MB each'
    ],
    submitLabelEn: 'Submit Poster & PPT',
    submitLabelId: 'Kumpulkan Poster & PPT',
    icon: 'FileText'
  }
];

export const RIC_GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxmUXPbTfsO5Sdv-1xsj5MFiBl9iA12dkHGeETy1XEfr1VY_1VZ92xlgaf3qrP2dWvaRQ/exec';
