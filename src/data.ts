...
export const COMPETITION_DIVISIONS: Division[] = [
  ...
  },
  {
    ...
    description: 'The Collaborative Robot (Cobot) division focuses on the design, programming, and operation of robotic arms. Participants are challenged to develop robot systems capable of performing various tasks with high precision, flexibility, and efficiency.',
    indonesianDescription: 'Divisi Collaborative Robot (Cobot) berfokus pada perancangan, pemrograman, dan pengoperasian robot lengan (robotic arm). Peserta ditantang mengembangkan sistem robot yang mampu melakukan berbagai tugas dengan tingkat presisi, fleksibilitas, dan efisiensi yang tinggi.',
    icon: 'Cpu',
    image: '/images/divisions/collaborative-robot.jpg',
    specHighlight: 'Robotic Arm Control',
    intensityScore: 90,
    glowColor: 'rgba(197, 160, 89, 0.4)',
    maxStaff: 2,
    hasSubCategory: false,
    hasLevels: true,
    levels: ['Vocational School'],
    hasLecturer: false,
    price: 'Rp. 500,000',
    priceUSD: '$30.00',
  ...
  },
  {
    ...
    hasSubCategory: false,
    hasLevels: true,
    levels: ['Elementary', 'Junior High', 'Senior High'],
    hasLecturer: true,
    price: 'Rp. 120,000',
    priceUSD: '$7.50',
