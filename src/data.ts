...
export const COMPETITION_DIVISIONS: Division[] = [
  {
    ...
    indonesianSubCategories: ['RC', 'Autonomous'],
    hasLevels: false,
    hasLecturer: false,
    capacity: 100,
    registered: 42,
  ...
  },
  {
    ...
    indonesianLevels: ['Mahasiswa', 'Pelajar SMA'],
    hasLecturer: false,
    capacity: 100,
    registered: 55,
    price: 'Rp. 250,000',
  ...
  },
  {
    ...
    indonesianLevels: ['Mahasiswa', 'Pelajar SMK'],
    hasLecturer: true,
    capacity: 60,
    registered: 18,
    price: 'Rp. 280,000',
  ...
  },
  {
    ...
    description: 'This competition division has been canceled. Please check other available divisions.',
    indonesianDescription: 'Mata lomba ini telah dibatalkan. Silakan lihat divisi lain yang tersedia.',
    icon: 'Cpu',
    image: '/images/divisions/collaborative-robot.jpg',
    specHighlight: 'Canceled',
    intensityScore: 0,
    glowColor: 'rgba(197, 160, 89, 0.4)',
    minMembers: 1,
    maxMembers: 1,
  ...
  },
  {
    ...
    hasSubCategory: false,
    hasLevels: true,
    levels: ['Junior (SD)', 'Senior (SMP & SMA)'],
    indonesianLevels: ['Junior (SD)', 'Senior (SMP & SMA)'],
    hasLecturer: false,
    capacity: 100,
    registered: 63,
    price: 'Rp. 120,000',
